...
- [x] **توحيد واجهة المستخدم (UI Unification)**: اعتماد الهوية الجديدة AwsanBot وتوفير لوحة تحكم موحدة `public/index.html`.
- [x] **إصلاح وتحديث سير العمل لبناء الأندرويد (CI/CD)**: ضبط صلاحيات `gradlew` ومسار مخرجات الـ APK في GitHub Actions.
